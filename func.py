...
def available_locations(loc1, loc2, names=False):  # Список доступных локаций
    if names:
...
def markov_chain():
    with open('/mnt/data/share/software/babka_sim/markov.json') as f:
        text = f.read()
